...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    excerpt: 'Boost first impressions and resale value with walkways, porch interlock, planting and lighting.',
    ...
    intro: [
      'Curb appeal is the first thing buyers, guests and neighbours notice, and it is one of the best returns you can get on a home. A front yard makeover ties together the walkway, porch, planting and lighting into one polished look.',
      'Because Tridan does landscaping and hardscaping in-house, we can refresh the whole front of your home as a single project. New interlock walkway and steps, updated planting and low-voltage lighting add up to a house that stops people on the sidewalk.',
    ],
    points: [
      ...
      { title: 'One-contractor refresh', body: 'Landscaping, hardscape and lighting handled together for a cohesive result.' },
    ],
    relatedServices: ['interlocking-patios', 'landscape-design', 'fences-gates'],
    faqs: [
      { q: 'Does curb appeal really add value?', a: 'Yes. Front-yard improvements like walkways, planting and lighting are among the highest-return updates you can make, both for resale value and for how quickly a home sells.' },
      { q: 'Can you handle the whole front-yard makeover in one project?', a: 'Yes. As a general contractor we combine the walkway, steps, planting and lighting into one coordinated project, so your curb appeal is transformed in a single visit.' },
    ],
  },
  {
  ...
  },
  {
    ...
    navName: 'Whole-Home Renovations',
    group: 'Interior',
    keyword: 'whole home renovation GTA',
    excerpt: 'Gut and transform a dated house into a cohesive, modern home, managed end to end by one contractor.',
    image: '1648475236583-2e25a6cbf3bd',
    gallery: ['1600489000022-c2086d79f9d4', '1584622650111-993a426fbf0a', '1665507299417-0985dc338ec7'],
    heroHeadline: 'Transform the Whole House at Once',
    intro: [
      'Sometimes a room at a time is not enough. When a house is dated throughout or the layout no longer works, a whole-home renovation lets you rethink everything at once, so the kitchen, bathrooms, flooring, trim and finishes all speak the same language when the dust settles.',
      'Doing it as one coordinated project is also more efficient and less disruptive than a string of separate jobs. Tridan manages the trades, the permits, the schedule and the finishes under one roof, with a single fixed price and one point of contact from demolition to the final walkthrough.',
    ],
    points: [
      { title: 'One cohesive design', body: 'Kitchen, baths, flooring, trim and finishes coordinated so the finished home feels intentional, not pieced together.' },
      { title: 'One team, one schedule', body: 'We sequence every trade so the project moves efficiently and you deal with one accountable contractor.' },
      { title: 'Fixed price, permits handled', body: 'A clear budget up front, with the drawings, permits and inspections managed for you.' },
    ],
    relatedServices: ['kitchen-renovations', 'bathroom-renovations', 'flooring'],
    faqs: [
      { q: 'How long does a whole-home renovation take?', a: 'It depends on size and scope, but most whole-home projects run three to six months of construction after design and permits. We give you a full schedule before work begins.' },
      { q: 'Can we live in the house during the renovation?', a: 'Sometimes, in stages, and sometimes it is easier to move out for the heaviest phases. We plan the sequence around what works for your family and seal off active work areas.' },
    ],
  },
  {
    slug: 'basement-rec-room',
    title: 'Basement Rec Rooms & Home Theatres',
    navName: 'Rec Rooms & Theatres',
    group: 'Interior',
    keyword: 'basement rec room ideas',
    excerpt: 'Turn an unfinished basement into a warm rec room, home theatre or games room the whole family uses.',
    image: '1765959617888-30837a158667',
    gallery: ['1584622650111-993a426fbf0a', '1665507299417-0985dc338ec7', '1620626011761-996317b8d101'],
    heroHeadline: 'A Basement Worth Hanging Out In',
    intro: [
      'A finished basement is the most affordable square footage you can add, and a rec room or home theatre is one of the most enjoyable ways to use it. Tridan turns cold, unfinished basements into warm, comfortable spaces for movie nights, games, a home gym or a place for the kids to spread out.',
      'We handle it all: moisture control and insulation so it stays warm and dry, the electrical for pot lights and media, comfortable flooring, and the finishes that make a basement feel like part of the home rather than an afterthought.',
    ],
    points: [
      { title: 'Warm and dry first', body: 'Proper moisture control, insulation and subfloor so the space is comfortable year-round, not a cold concrete box.' },
      { title: 'Wired for media', body: 'Pot lights, dimmers and the electrical for a TV or projector setup, done by licensed trades and inspected.' },
      { title: 'Built for how you relax', body: 'Rec room, theatre, games area, gym or a mix, laid out to suit your family.' },
    ],
    relatedServices: ['basement-finishing', 'electrical', 'flooring'],
    faqs: [
      { q: 'How much does it cost to finish a basement as a rec room?', a: 'A finished basement rec room typically runs $45,000 to $85,000 depending on size, a bathroom or wet bar, and finishes. We provide a fixed quote after seeing the space.' },
      { q: 'Do I need a permit to finish my basement?', a: 'Yes, finishing a basement requires a building permit, and we handle the drawings, permit and inspections as part of the project.' },
    ],
  },
  {
    slug: 'in-law-suite',
    title: 'In-Law & Multigenerational Suites',
    navName: 'In-Law Suites',
    group: 'Interior',
    keyword: 'in-law suite renovation',
    excerpt: 'Create a comfortable, private suite for parents or family, with its own living space, bath and often a kitchenette.',
    image: '1770757587087-766db2874c21',
    gallery: ['1765959617888-30837a158667', '1584622650111-993a426fbf0a', '1600489000022-c2086d79f9d4'],
    heroHeadline: 'Room for the Whole Family',
    intro: [
      'More families are choosing to live together, whether it is aging parents moving in or adult children staying close. An in-law suite gives everyone their own space and privacy while keeping family under one roof. Tridan builds these suites in basements, additions or reconfigured main-floor space.',
      'A good suite balances independence and connection: a private entrance where it makes sense, a comfortable bedroom and bathroom, often a kitchenette, and thoughtful, accessible design so it works for years. We handle the layout, permits and build end to end.',
    ],
    points: [
      { title: 'Private and comfortable', body: 'A dedicated bedroom, bathroom and living space, often with a kitchenette and its own entrance.' },
      { title: 'Accessible by design', body: 'Barrier-free options like curbless showers and wider doorways so the suite works as needs change.' },
      { title: 'Built to code and permitted', body: 'Proper egress, fire separation and ceiling height where a full second unit is involved, with permits handled.' },
    ],
    relatedServices: ['basement-finishing', 'home-additions', 'bathroom-renovations'],
    faqs: [
      { q: 'What is the difference between an in-law suite and a legal second unit?', a: 'An in-law suite is living space for family, while a legal second unit is a registered, code-compliant rental apartment. We can build either, and we confirm the requirements based on how you plan to use it.' },
      { q: 'Where can an in-law suite go?', a: 'Most commonly a basement, but also a home addition, a garden suite, or reconfigured main-floor space. We assess your home and recommend the best option.' },
    ],
  },
  {
    slug: 'pre-sale-refresh',
    title: 'Pre-Sale Home Refresh',
    navName: 'Pre-Sale Refresh',
    group: 'Interior',
    keyword: 'renovations before selling home',
    excerpt: 'High-return updates that help your home show better and sell for more: kitchens, flooring and curb appeal.',
    image: '1583847268964-b28dc8f51f92',
    gallery: ['1522600579804-c66aa476298e', '1600489000022-c2086d79f9d4', '1665507299417-0985dc338ec7'],
    heroHeadline: 'Sell for More, With the Right Updates',
    intro: [
      'When you are getting ready to list, not every renovation pays off, but the right ones do. An updated kitchen, new flooring and improved curb appeal are consistently among the highest-return updates for resale, and they help a home show beautifully in photos and in person.',
      'Because Tridan does renovations and landscaping in-house, we can refresh the whole property for the market on a tight timeline: quick kitchen and bath updates, new flooring, and a front-yard tidy-up, coordinated so it is done right before your photos and open house.',
    ],
    points: [
      { title: 'Focus on what returns', body: 'Kitchens, flooring and curb appeal, the updates that consistently pay back at resale.' },
      { title: 'One contractor, tight timeline', body: 'Renovations and landscaping coordinated so everything is ready before your listing photos.' },
      { title: 'Show-ready finish', body: 'Clean, neutral, move-in-ready results that help buyers picture themselves in the home.' },
    ],
    relatedServices: ['kitchen-renovations', 'flooring'],
    faqs: [
      { q: 'What renovations add the most value before selling?', a: 'An updated kitchen, new or refinished flooring, and curb appeal give the best return for most homes. We help you focus the budget where it pays off.' },
      { q: 'Can you work on a tight timeline before listing?', a: 'Yes. Pre-sale work is time-sensitive, and because we handle renovations and landscaping in-house, we can coordinate a fast, complete refresh before your photos and open house.' },
    ],
  },
];
