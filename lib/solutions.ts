...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    intro: [
      'Sometimes a room at a time is not enough. When a house is dated throughout or the layout no longer works, a whole-home renovation lets you rethink everything at once, so the kitchen, bathrooms, flooring, trim and paint all speak the same language when the dust settles.',
    ...
    points: [
      { title: 'One cohesive design', body: 'Kitchen, baths, flooring, trim and paint coordinated so the finished home feels intentional, not pieced together.' },
    ...
    relatedServices: ['kitchen-renovations', 'bathroom-renovations', 'flooring', 'interior-painting'],
    faqs: [
  ...
  },
  {
    ...
    excerpt: 'High-return updates that help your home show better and sell for more: paint, kitchens, flooring and curb appeal.',
    ...
    intro: [
      'When you are getting ready to list, not every renovation pays off, but the right ones do. Fresh paint, an updated kitchen, new flooring and improved curb appeal are consistently among the highest-return updates for resale, and they help a home show beautifully in photos and in person.',
      'Because Tridan does painting, renovations and landscaping under one roof, we can refresh the whole property for the market on a tight timeline: interior paint, quick kitchen and bath updates, flooring, and a front-yard tidy-up, coordinated so it is done right before your photos and open house.',
    ],
    points: [
      { title: 'Focus on what returns', body: 'Paint, kitchens, flooring and curb appeal, the updates that consistently pay back at resale.' },
      { title: 'One contractor, tight timeline', body: 'Painting, reno and landscaping coordinated so everything is ready before your listing photos.' },
      { title: 'Show-ready finish', body: 'Clean, neutral, move-in-ready results that help buyers picture themselves in the home.' },
    ],
    relatedServices: ['interior-painting', 'kitchen-renovations', 'flooring', 'exterior-painting'],
    faqs: [
      { q: 'What renovations add the most value before selling?', a: 'Fresh neutral paint, an updated kitchen, new or refinished flooring, and curb appeal give the best return for most homes. We help you focus the budget where it pays off.' },
      { q: 'Can you work on a tight timeline before listing?', a: 'Yes. Pre-sale work is time-sensitive, and because we handle paint, renovations and landscaping in-house, we can coordinate a fast, complete refresh before your photos and open house.' },
    ],
  },
];
