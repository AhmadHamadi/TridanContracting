...
export const categories: Category[] = [
  ...
  },
  {
    ...
    short: 'Painting',
    blurb:
      'Interior and exterior painting with meticulous prep and a factory-smooth finish that lasts.',
    image: '1675191863404-e1db618d6655',
    icon: 'paint',
  },
  {
    slug: 'landscaping',
...
export const services: Service[] = [
  ...
  // ------------------------------ RENOVATIONS ------------------------------
  {
    ...
    inclusions: [
      ...
      'Flooring, lighting, painting and trim',
  ...
  },
  {
    ...
    related: ['kitchen-renovations', 'basement-finishing', 'interior-painting'],
  },
  {
    ...
    inclusions: [
      ...
      'Drywall, flooring, trim, doors and paint',
  ...
  },
  {
    ...
    related: ['basement-finishing', 'kitchen-renovations', 'exterior-painting'],
  },
  {
    slug: 'flooring',
    category: 'renovations',
  ...
  // ------------------------------- PAINTING --------------------------------
  {
    ...
    keyword: 'interior painters',
    excerpt:
      'Meticulous interior painting, proper prep, premium paint and crisp, straight lines.',
    image: '1522600579804-c66aa476298e',
    gallery: ['1522600579804-c66aa476298e', '1759406066673-f76869a4e6db', '1609241506098-80fc37c6325f'],
    heroHeadline: 'Interior Painting Done Meticulously',
    intro: [
      'A quality paint job is 80% preparation and 20% paint, and it shows. Tridan’s painters fill, sand, caulk and prime properly, protect your floors and furniture, and cut crisp, straight lines for a finish that looks sprayed-on smooth and lasts for years.',
      'Walls, ceilings, trim, doors and accent features, we use premium Benjamin Moore and Sherwin-Williams products, keep a tidy site, and treat your home like it’s ours. No overspray on the floors, no fuzzy lines, no shortcuts.',
    ],
    benefits: [
      'Thorough prep: fill, sand, caulk, prime and protect',
      'Premium Benjamin Moore & Sherwin-Williams paints',
      'Crisp cut lines, even coats and full coverage',
      'Walls, ceilings, trim, doors, accent walls and feature finishes',
      'Clean, respectful, on-schedule crews',
    ],
    inclusions: [
      'Furniture moving and full surface protection',
      'Patching, sanding, caulking and priming',
      'Two premium finish coats (or as specified)',
      'Trim, doors, ceilings and detail work',
      'Daily cleanup and final walkthrough',
    ],
    materials: ['Benjamin Moore', 'Sherwin-Williams', 'Low-VOC options'],
    priceRange: '$3.50 – $8 / sq ft or by room',
    timeline: '1 day – 1 week',
    faqs: [
      { q: 'How many coats of paint do you apply?', a: 'Two finish coats over primer as standard, more for deep colour changes or when going light over dark. Full, even coverage is the point.' },
      { q: 'Do you move furniture and protect floors?', a: 'Yes, we move and cover furniture, mask trim and fully protect floors. You come home to clean rooms, not a mess.' },
      { q: 'What paint do you use?', a: 'Premium Benjamin Moore and Sherwin-Williams lines, with low-VOC options for bedrooms and homes with kids and pets.' },
    ],
    related: ['exterior-painting', 'cabinet-refinishing', 'kitchen-renovations'],
  },
  {
    ...
    keyword: 'exterior painters',
    excerpt:
      'Exterior painting and staining for siding, brick, stucco and trim, prepped to survive GTA weather.',
    image: '1759406066673-f76869a4e6db',
    gallery: ['1759406066673-f76869a4e6db', '1609241506098-80fc37c6325f', '1675191863404-e1db618d6655'],
    heroHeadline: 'Exterior Painting That Survives the Seasons',
    intro: [
      'Exterior paint has to fight sun, rain, freeze-thaw and everything else the GTA throws at it, so prep and product matter even more than inside. Tridan power-washes, scrapes, sands, primes and caulks before a brush touches paint, then applies exterior-grade coatings built to hold colour and adhesion for years.',
      'Siding, brick, stucco, trim, doors, soffits and fascia, we transform your home’s curb appeal and protect it at the same time, with clean lines and proper coverage that don’t peel next spring.',
    ],
    benefits: [
      'Power-washing, scraping, sanding, priming and caulking',
      'Exterior-grade coatings for siding, brick, stucco and trim',
      'Colour changes, refreshes and full curb-appeal transformations',
      'Doors, soffits, fascia, railings and garage doors',
      'Weather-timed scheduling for proper cure',
    ],
    inclusions: [
      'Power-washing and surface preparation',
      'Scraping, sanding, priming and caulking',
      'Two coats of exterior-grade paint or stain',
      'Trim, doors, soffit, fascia and detail work',
      'Landscape protection and full cleanup',
    ],
    materials: ['Exterior acrylics', 'Masonry & stucco coatings', 'Solid & semi-transparent stains'],
    priceRange: '$4,000 – $18,000+',
    timeline: '3 days – 2 weeks',
    faqs: [
      { q: 'When is the best time to paint exteriors in the GTA?', a: 'Roughly May through October, when temperatures and humidity let the paint cure properly. We schedule around weather to protect your investment.' },
      { q: 'Can you paint brick and stucco?', a: 'Yes, with the right masonry primers and breathable coatings. Painting brick is permanent, so we make sure it’s the right call and prep it correctly.' },
      { q: 'How long will exterior paint last?', a: 'With proper prep and premium product, expect 7–10+ years on siding and trim. The prep is what determines whether you get 3 years or 10.' },
    ],
    related: ['interior-painting', 'home-additions', 'fences-gates'],
  },
  {
    slug: 'cabinet-refinishing',
    category: 'painting',
    name: 'Cabinet Painting & Refinishing',
    navName: 'Cabinet Refinishing',
    keyword: 'cabinet painters',
    excerpt:
      'Spray-finished cabinet painting that gives your kitchen a new look for a fraction of replacement.',
    image: '1609241506098-80fc37c6325f',
    gallery: ['1609241506098-80fc37c6325f', '1675191863404-e1db618d6655', '1522600579804-c66aa476298e'],
    heroHeadline: 'A New Kitchen Look, Without Replacing It',
    intro: [
      'If your cabinet boxes are solid but the finish is dated, refinishing gives you a brand-new kitchen look for a fraction of the cost of replacement. Tridan degreases, sands, primes and sprays your cabinets for a factory-smooth, durable finish, no brush marks, no peeling.',
      'We remove doors and drawers, label and spray them in a controlled setup, and finish the boxes in place, so you get crisp, hard-wearing colour on the surfaces your hands touch every day.',
    ],
    benefits: [
      'Factory-smooth sprayed finish, no brush or roller marks',
      'Proper degrease, sand, bond-primer and durable topcoat',
      'Fraction of the cost and time of replacing cabinets',
      'New hardware, colour matching and accent islands',
      'Kitchen usable again in days, not weeks',
    ],
    inclusions: [
      'Door/drawer removal, labelling and hardware removal',
      'Degreasing, sanding and bonding primer',
      'Sprayed durable cabinet-grade finish',
      'Box painting in place and reassembly',
      'Optional new hardware install and cleanup',
    ],
    materials: ['Cabinet-grade lacquers/enamels', 'Bonding primers', 'Colour matching'],
    priceRange: '$3,500 – $9,000',
    timeline: '3 – 6 days',
    faqs: [
      { q: 'How durable is a painted cabinet finish?', a: 'Very, with proper degreasing, bonding primer and a sprayed cabinet-grade topcoat, the finish holds up to daily kitchen use for years. Prep is everything, and we don’t skip it.' },
      { q: 'Can you change my cabinet colour completely?', a: 'Yes, dark to white, oak to charcoal, whatever you like. We can also spray an island a different accent colour for a two-tone look.' },
      { q: 'How long does refinishing take?', a: 'Most kitchens are done in 3–6 days, and you can use the kitchen for most of that time, far faster and cheaper than replacement.' },
    ],
    related: ['kitchen-renovations', 'interior-painting', 'exterior-painting'],
  },
